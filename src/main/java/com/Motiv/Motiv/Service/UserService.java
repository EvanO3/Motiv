...
public class UserService {
    ...
    // public ResponseEntity<String> profileSetUp(UserDTO user){
    //     /**
    //      * Create user, use users jwt to find their information
    //      */
    //     try{
    //         UserDTO userSetUp = new UserDTO(user.getName(), user.getWeight(), user.getHeight(), user.getAge());
